    ...
    <nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center px-4 sm:px-6 lg:px-8">
        <div className="mr-2 sm:mr-6 flex items-center space-x-2">
          ...
          />
          <span className="font-bold text-xl whitespace-nowrap hidden sm:inline">
            DootRec
          </span>
        </div>
        ...
        <div className="flex items-center space-x-0 sm:space-x-1">
          {navLinks.map((link) => (
            <Button
              ...
              variant="ghost"
              asChild
              className="px-2 sm:px-3 text-sm font-medium text-muted-foreground hover:text-foreground"
            >
              <Link
                href={link.href}
